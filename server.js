...
setInterval(() => {
  http.get(`http://rebelxsys.glitch.me/`);
}, 280000);
...
const dev = ["427559563378556929"]; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "427559563378556929"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`REBEL.-X`);
  console.log(`----------------`);
  console.log(`ON ${client.guilds.size} Servers '     Script By : REBEL.-X  `);
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("Magic City RP" ); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@427559563378556929>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage(
        ""
      )
